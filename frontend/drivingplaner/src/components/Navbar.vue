    ...
    <nav class="bg-black p-6 relative z-50">
      <div class="flex items-center justify-between w-full">
        ...
        <div class="relative" ref="dropdownContainer"> <!-- This is the profile image-->
          ...
          >
            <div
                class="absolute inset-0 bg-amber-500/40 blur-xl rounded-full scale-110 group-hover:scale-150 transition-all duration-500"></div>
            <img
          ...
          >
            <a href="/profile"
               class="block px-4 py-2 text-amber-200/70 hover:text-amber-400 hover:bg-white/5 transition-colors">Profile</a>
            <a href="/settings"
               class="block px-4 py-2 text-amber-200/70 hover:text-amber-400 hover:bg-white/5 transition-colors">Settings</a>
            ...
            <a href="/login" v-if="!login"
               class="block px-4 py-2 text-green-400 hover:bg-green-500/10 transition-colors">Login</a>
          </div>
        </div>
