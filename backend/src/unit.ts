...
export function ensureSampleDataInserted(unit: Unit): "inserted" | "skipped" {
  ...
  function insertSchools(): void {
    const records = [
      ...
      { Name: "Fahrschule fairdrive Leonding", Ort: "Ruflinger Straße 17, 4060 Leonding", Inhaber: "M. Schüttengruber", Email: "leonding@fairdrive.at", Link: "https://www.fairdrive.at/", Phone:"+43 732 / 38 53 55 1" },
