...
export function ensureSampleDataInserted(unit: Unit): "inserted" | "skipped" {
  ...
  function insertSchools(): void {
    const records = [
      ...
      { Name: "Fahrschule Höglinger", Ort: "Salzburger Straße 14, 4840 Vöcklabruck", Inhaber: "Höglinger", Email: "voecklabruck@drive-hoeglinger.at", Link: "https://www.hoeglinger-voecklabruck.at/", Phone:""},
